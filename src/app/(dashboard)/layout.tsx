...
const navItems = [
  { href: "/trips", label: "My Trips", icon: "M3 7v10a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2h-6l-2-2H5a2 2 0 00-2 2z" },
    ...
    <div className="flex h-screen bg-gray-50">
      ...
      >
        ...
        <div className="px-4 py-4">
          <Link
            href="/trips?new=true"
            className="flex items-center justify-center gap-2 w-full rounded-lg bg-blue-600 px-4 py-2.5 text-sm font-medium text-white hover:bg-blue-700 transition"
          >
        ...
        <div className="border-t border-gray-100 px-4 py-4">
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs text-gray-500 truncate">demo@tripgenie.ai</p>
            </div>
